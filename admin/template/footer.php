   <!--main content end-->
      ...
      <footer class="site-footer">
          <div class="text-center">
              <?php echo date('Y');?> - Sistem Penjualan Barang Elektronik Berbasis Web | 
              By <a href="https://instagram.com/ilhamnurrhakim?igshid=NzZlODBkYWE4Ng%3D%3D&utm_source=qr" style="color:yellow;font-weight:700;" target="_blank">ilhamnurrhakim</a>
              <a href="#" class="go-top">
